...
Describe 'Get-ParsedHelpFlags' {
  It "The supplied cmake help output contains 25 flags" {
    $flags = Get-ParsedHelpFlags -HelpData (Get-Content "$PSScriptRoot\TextTests\cmake.txt")
  ...
  It "The supplied make help output contains 26 flags" {
    $flags = Get-ParsedHelpFlags -HelpData (Get-Content "$PSScriptRoot\TextTests\make.txt")
    $flags.Count | Should -Be 26
  }

  It "The supplied dfu-util help output contains 20 flags" {
    $flags = Get-ParsedHelpFlags -HelpData (Get-Content "$PSScriptRoot\TextTests\dfu-util.txt")
    $flags.Count | Should -Be 20
  }

  It "The supplied gcc help output contains 37 flags" {
    $flags = Get-ParsedHelpFlags -HelpData (Get-Content "$PSScriptRoot\TextTests\gcc.txt")
    $flags.Count | Should -Be 37
  }
}

Describe 'Get-ParsedHelpOptions' {
  It "The supplied cmake help output contains 50 options" {
    $options = Get-ParsedHelpOptions -HelpData (Get-Content "$PSScriptRoot\TextTests\cmake.txt")
    $options.Count | Should -Be 50
  }

  It "The supplied make help output contains 35 options" {
    $options = Get-ParsedHelpOptions -HelpData (Get-Content "$PSScriptRoot\TextTests\make.txt")
    $options.Count | Should -Be 35
  }

  It "The supplied dfu-util help output contains 20 options" {
    $options = Get-ParsedHelpOptions -HelpData (Get-Content "$PSScriptRoot\TextTests\dfu-util.txt")
    $options.Count | Should -Be 20
  }

  It "The supplied gcc help output contains 5 options" {
    $options = Get-ParsedHelpOptions -HelpData (Get-Content "$PSScriptRoot\TextTests\gcc.txt")
